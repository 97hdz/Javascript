...
const currentX = '<img id="X" src="barcelona.png" width="50%" height="100">' // Para poner las imagenes envez de las letras.
const currentO = '<img id="O" src="real.png" width="50%" height="100">'
